...
# Укажите токен вашего Telegram-бота и chat_id администратора
TELEGRAM_BOT_TOKEN = os.environ.get('TELEGRAM_BOT_TOKEN', '7995747254:AAHlYaFAKv8FTaDZjWhsGnUFcFWjG6dLOmA')
TELEGRAM_ADMIN_CHAT_ID = os.environ.get('TELEGRAM_ADMIN_CHAT_ID', '5777052726')
# ========================================

# Ключ для django-encrypted-model-fields (НЕ выкладывайте в публичный репозиторий!)
# Сгенерируйте ключ командой:
#   python -c "from cryptography.fernet import Fernet; print(Fernet.generate_key().decode())"
# и добавьте его в переменные окружения или .env файл:
